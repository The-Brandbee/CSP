...
var aboutfeatureApi = require("../../api/aboutfeature");
...
var aboutfeature = {
    add: async function (req, res, next) {
        ...
        aboutfeatureApi.add(req.body, function (err, data) {
          if (err) {
            return next(err);
          }
          res.json(data);
      ...
      fetchAll: function (req, res, next) {
        aboutfeatureApi.fetchAll(function (err, data) {
            if (err) {
              return next(err);
            }
     ...
     fetchById: function(req, res, next) {
      ...
      aboutfeatureApi.fetchById(req.params.id, function(err, data) {
    ...
    update: async function (req, res, next) {
      ...
      aboutfeatureApi.update(params, function (err, data) {
        if (err) {
          return next(err);
        }
        res.json(data);
    ...
    delete:  function(req, res, next) {
      ...
      aboutfeatureApi.deleteId({ id: req.body.id}, function(err, data) {
