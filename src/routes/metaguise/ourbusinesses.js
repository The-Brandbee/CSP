...
var ourbusinessesApi = require("../../api/ourbusinesses");
...
var ourbusinesses = {
    add: async function (req, res, next) {
        ...
        ourbusinessesApi.add(req.body, function (err, data) {
          if (err) {
            return next(err);
          }
          res.json(data);
      ...
      fetchAll: function (req, res, next) {
        ourbusinessesApi.fetchAll(function (err, data) {
            if (err) {
              return next(err);
            }
     ...
     fetchById: function(req, res, next) {
      ...
      ourbusinessesApi.fetchById(req.params.id, function(err, data) {
    ...
    update: async function (req, res, next) {
      ...
      ourbusinessesApi.update(params, function (err, data) {
        if (err) {
          return next(err);
        }
        res.json(data);
    ...
    delete:  function(req, res, next) {
      ...
      ourbusinessesApi.deleteId({ id: req.body.id}, function(err, data) {
