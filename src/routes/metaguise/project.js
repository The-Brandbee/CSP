...
var project = {
    add: async function (req, res, next) {
        ...
        projectApi.add(req.body, function (err, data) {
          if (err) {
            return next(err);
          }
          res.json(data);
      ...
      fetchAll: function (req, res, next) {
        projectApi.fetchAll(function (err, data) {
            if (err) {
              return next(err);
            }
     ...
     fetchById: function(req, res, next) {
      ...
      projectApi.fetchById(req.params.id, function(err, data) {
    ...
    fetchByUrl: function(req, res, next) {
      ...
      projectApi.fetchByUrl(req.params.url, function(err, data) {
    ...
    update: async function (req, res, next) {
      ...
      projectApi.update(params, function (err, data) {
        if (err) {
          return next(err);
        }
        res.json(data);
    ...
    delete:  function(req, res, next) {
      ...
      projectApi.deleteId({ id: req.body.id}, function(err, data) {
