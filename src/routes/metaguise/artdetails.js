...
var artdetailsApi = require("../../api/artdetails");
...
var artdetails = {
    add: async function (req, res, next) {
        ...
        artdetailsApi.add(req.body, function (err, data) {
          if (err) {
            return next(err);
          }
          res.json(data);
      ...
      fetchAll: function (req, res, next) {
        artdetailsApi.fetchAll(function (err, data) {
            if (err) {
              return next(err);
            }
     ...
     fetchById: function(req, res, next) {
      ...
      artdetailsApi.fetchById(req.params.id, function(err, data) {
    ...
    fetchByUrl: function(req, res, next) {
      ...
      artdetailsApi.fetchByUrl(req.params.url, function(err, data) {
    ...
    update: async function (req, res, next) {
      ...
      artdetailsApi.update(params, function (err, data) {
        if (err) {
          return next(err);
        }
        res.json(data);
    ...
    delete:  function(req, res, next) {
      ...
      artdetailsApi.deleteId({ id: req.body.id}, function(err, data) {
