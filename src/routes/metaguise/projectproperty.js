...
var projectpropertyApi = require("../../api/projectproperty");
...
var projectproperty = {
    add: async function (req, res, next) {
        ...
        projectpropertyApi.add(req.body, function (err, data) {
          if (err) {
            return next(err);
          }
          res.json(data);
      ...
      fetchAll: function (req, res, next) {
        projectpropertyApi.fetchAll(function (err, data) {
            if (err) {
              return next(err);
            }
     ...
     fetchById: function(req, res, next) {
      ...
      projectpropertyApi.fetchById(req.params.id, function(err, data) {
    ...
    fetchByUrl: function(req, res, next) {
      ...
      projectpropertyApi.fetchByUrl(req.params.url, function(err, data) {
    ...
    update: async function (req, res, next) {
      ...
      projectpropertyApi.update(params, function (err, data) {
        if (err) {
          return next(err);
        }
        res.json(data);
    ...
    delete:  function(req, res, next) {
      ...
      projectpropertyApi.deleteId({ id: req.body.id}, function(err, data) {
