...
var collaborationsApi = require("../../api/collaborations");
...
var collaborations = {
    add: async function (req, res, next) {
        ...
        collaborationsApi.add(req.body, function (err, data) {
          if (err) {
            return next(err);
          }
          res.json(data);
      ...
      fetchAll: function (req, res, next) {
        collaborationsApi.fetchAll(function (err, data) {
            if (err) {
              return next(err);
            }
     ...
     fetchById: function(req, res, next) {
      ...
      collaborationsApi.fetchById(req.params.id, function(err, data) {
    ...
    update: async function (req, res, next) {
      ...
      collaborationsApi.update(params, function (err, data) {
        if (err) {
          return next(err);
        }
        res.json(data);
    ...
    delete:  function(req, res, next) {
      ...
      collaborationsApi.deleteId({ id: req.body.id}, function(err, data) {
