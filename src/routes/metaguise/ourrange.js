...
var ourrangeApi = require("../../api/ourrange");
...
var ourrange = {
    add: async function (req, res, next) {
        ...
        ourrangeApi.add(req.body, function (err, data) {
          if (err) {
            return next(err);
          }
          res.json(data);
      ...
      fetchAll: function (req, res, next) {
        ourrangeApi.fetchAll(function (err, data) {
            if (err) {
              return next(err);
            }
     ...
     fetchById: function(req, res, next) {
      ...
      ourrangeApi.fetchById(req.params.id, function(err, data) {
    ...
    update: async function (req, res, next) {
      ...
      ourrangeApi.update(params, function (err, data) {
        if (err) {
          return next(err);
        }
        res.json(data);
    ...
    delete:  function(req, res, next) {
      ...
      ourrangeApi.deleteId({ id: req.body.id}, function(err, data) {
