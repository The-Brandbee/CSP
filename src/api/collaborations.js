...
var collaborationsModel = require("../model/collaborations");
...
var collaborations = {
    add: function (params, cb) {
        ...
        if (params.files && params.files.image) {
          ...
          var filePath = "public/uploads/collaborations/" + fileName;
  ...
  var filePaths = "public/uploads/collaborations/" + fileNames;
  ...
  createData["mobileimage"] = filePaths;
          ...
          collaborationsModel.create(createData, function (err, result) {
          if (err) {
            return cb(err);
          }
      ...
      fetchAll: function (cb) {
        collaborationsModel.fetchAll(function (err, result) {
          if (err) {
            return cb(err);
          }
          return cb(err, result);
      ...
      fetchById: function(id, cb) {
        collaborationsModel.fetchById(id, function(err, result) {
           if (err) {
                return cb(err);
            }
            return cb(err, result);
  ...
  createData["mobileimage"] = filePaths;
      ...
      collaborationsModel.update(params._id, createData, function (err, result) {
        if (err) {
          return cb(err);
        }
  
        collaborationsModel.fetchById(params._id, function (err, updatedData) {
          if (err) {
            return cb(err);
          }
    ...
    deleteId: function(params, cb) {
      collaborationsModel.deleteId(params, function(err, result) {
         if (err) {
              return cb(err);
          }
          return cb(err, result);
